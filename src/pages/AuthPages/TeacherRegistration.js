...
const TeacherRegistration = ({type}) => {
              ...
              <Form noValidate validated={validated} onSubmit={handleSubmit}>
                ...
                >
                  ...
                  <div className="row">
                    <div className="col-lg-6 col-sm-12 cx-mb-10">
                      <div className="fieldSetCUST">
                        ...
                        <span className="legendHere">
                          First Name<span className="ashhStar"> &#42;</span>{" "}
                        </span>
                      </div>
                    </div>
                    <div className="col-lg-6 col-sm-12 cx-mb-10">
                      <div className="fieldSetCUST">
                        ...
                        <span className="legendHere">
                          Last Name<span className="ashhStar"> &#42;</span>{" "}
                        </span>
                      </div>
                    </div>
                    <div className="col-lg-6 col-sm-12 cx-mb-10">
                    ...
                    <div className="col-lg-6 col-sm-12 cx-mb-20">
                      <div className="fieldSetCUST">
                        <span className="legendHere">
                          Gender<span className="ashhStar"> &#42;</span>{" "}
                        </span>
                        <Form.Select
                          class="form-select"
                          required
                    ...
                    <div className="col-lg-6 col-sm-12 cx-mb-10">
                      <div className="fieldSetCUST cx-mb-10">
                        ...
                        />
                        <span className="legendHere">
                          Date Of Birth<span className="ashhStar"> &#42;</span>{" "}
                        </span>
                    ...
                    <div className="col-lg-6 col-sm-12 cx-mb-10">
                      ...
                      <div className="fieldSetCUST">
                        ...
                        <span className="legendHere">
                          Contact Number<span className="ashhStar"> </span>{" "}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bottom-wrapper border-top">
                    ...
                    <div className="button-wrapper">
                      ...
                      <div className="right-button">
                        ...
                        <button className="cx-btn-1"  onClick={() => navigate("/Dashboard")}>Submit</button>
                      </div>
                    </div>
                  </div>
                </div>
